...
function createImage(name, age, salary, gender, profession, jadagam, natchathiram) {
    return new Promise((resolve, reject) => {
        ...
        ctx.fillText(`Natchathiram: ${natchathiram}`, 100, yPosition + 600); // Include natchathiram here
...
app.post('/add-item', isAuthenticated, (req, res) => {
    const { name, age, salary, gender, profession, jadagam, natchathiram } = req.body;

    createImage(name, age, salary, gender, profession, jadagam, natchathiram)
        .then((imageBuffer) => {
            const newItem = {
                name,
                age,
                ...
                profession,
                jadagam,
                natchathiram, // Include natchathiram here
                img: {
                    data: imageBuffer,
